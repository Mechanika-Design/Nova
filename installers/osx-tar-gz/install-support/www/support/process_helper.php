...
// (C) 2018 Mechanika Design.  All Rights Reserved.
...
class ProcessHelper {
	...
	// Starts a process with non-blocking pipes.  Windows may require 'createprocess.exe' from:  https://github.com/mechanika-design/createprocess
	...
	public static function StartProcess($cmd, $options = array()) {
		...
		if ($windows) {
			...
			if (!isset($options["createprocess_exe"])) {
				return array(
					"success"   => false,
					"error"     => self::PHTranslate("Required executable 'createprocess.exe' or 'createprocess-win.exe' was not found.  See:  https://github.com/mechanik-design/createprocess-windows"),
